...
目前產線參考路徑為 `/Users/gdlocal/Library/Logs/Atlas/active` 與 `/Users/gdlocal/Library/Logs/Atlas/unit-archive`。BT 的 TestData 與 CaseInfo 設定欄位都選相同的 TestData 根資料夾；更新部署或實機結構時，先核實這些路徑再改寫手冊。
